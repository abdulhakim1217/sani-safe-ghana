...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "IoT-powered early warning system that detects pit latrine overflow and dangerous gas buildup in schools and communities across Northern Ghana." },
      { name: "author", content: "Sani Alert Ghana" },
      { property: "og:title", content: "Sani Alert Ghana" },
      { property: "og:description", content: "Preventing sanitation disasters before they happen — smart, solar-powered IoT monitoring for schools and communities." },
